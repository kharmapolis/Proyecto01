...
display vlan 210           ← Verificación (tagged: Ethernet 0/0/1 y 0/0/2)
save
                                       

#### (aquí insertaré foto de los comandos de huawei os `display interfaces brief` y `display vlan 210` , el dia de mañana 04/02/2026)
